...
export const PrivacyPolicyContent: React.FC = () => {
  ...
  return (
  <div className="p-8 text-lg max-w-[1400px] mx-auto w-full privacy-policy-content">
    ...
    <p>5.2. Пользователь также может удалить предоставленную им в рамках определенной учетной записи персональную информацию, обратившись в Компанию по телефону <a href={activeRegion.phoneHref} className="text-accent underline">{activeRegion.phoneDisplay}</a>.</p>
    ...
    <ul className="list-disc ml-8">
      <li>Телефон: <a href={activeRegion.phoneHref} className="text-accent underline">{activeRegion.phoneDisplay}</a></li>
      <li>Email: <a href={`mailto:${activeRegion.email}`} className="text-accent underline">{activeRegion.email}</a></li>
