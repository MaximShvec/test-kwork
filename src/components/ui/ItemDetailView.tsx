...
import { ArrowLeft, Drill, Hammer, Wrench, Construction } from 'lucide-react';
        ...
        <div className="flex-grow overflow-y-auto border-2 border-border rounded-lg m-3 md:m-5 flex flex-col">
          <CardHeader className="p-3 md:p-4 border-b border-border flex-shrink-0">
            <div className="flex items-center justify-between">
              <Button variant="ghost" size="icon" onClick={onClose} className="text-accent hover:bg-accent/10 min-w-[44px] min-h-[44px]">
